...
// make true if want auto voice reply if someone menetion you 
     ...
     MENU_IMAGE_URL: process.env.MENU_IMAGE_URL || "https://files.catbox.moe/td29dv.png",
// add custom menu and mention reply image url

       ALIVE_IMG: process.env.ALIVE_IMG || "https://files.catbox.moe/td29dv.png",
// add img for alive msg

        LIVE_MSG: process.env.LIVE_MSG || "> ʙᴏᴛ ɪs sᴘᴀʀᴋɪɴɢ ᴀᴄᴛɪᴠᴇ ᴀɴᴅ ᴀʟɪᴠᴇ\n\n\nᴋᴇᴇᴘ ᴜsɪɴɢ ✦𝐁𝐑𝐎𝐊𝐄𝐍✦ ғʀᴏᴍ ᴍᴀʟᴠɪɴ ᴛᴇᴄʜ ɪɴᴄ⚡",
// add alive msg here 


        STICKER_NAME: process.env.STICKER_NAME || "𝐁𝐑𝐎𝐊𝐄𝐍",
...
OWNER_NAME: process.env.OWNER_NAME || "𝐁𝐑𝐎𝐊𝐄𝐍",
// add bot owner name
